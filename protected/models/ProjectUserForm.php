...
* the form data related to adding an existing user to a project. It is used by the 'Adduser' action o 'ProjectController'.
*/
  ...
  */
  public function verify($attribute,$params)
  {
   if(!$this->hasErrors())  // we only want to authenticate when no other input errors are present
   {
       ...
       {
           $this->addError('username','This user has already beenadded to the project.');
        }
        else 
        {
